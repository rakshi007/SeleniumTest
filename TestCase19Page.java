...
//edit chart05
    ...
    public TestCase19Page(WebDriver driver) {
        this.driver = driver;
...
//Char
    ...
    public void tally() {
        ...
        WebElement addpart = wait.until(ExpectedConditions.elementToBeClickable(tally));
        addpart.click();
