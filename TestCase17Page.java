...
private By  charaaddbutton= By.xpath("//button[text()=' Add ']");private By  dropdownatt = By.xpath("(//lib-devextreme-selectbox)[3]");
...
public TestCase17Page(WebDriver driver) {
	 this.driver =  driver;
	...
	//seq
		 ...
		 public void addseqlink() {
			...
			public void draganddrop() {
				...
				WebElement para = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='No  ']")));
