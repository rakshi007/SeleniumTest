...
public class TestCase22Page {
    ...
    private By oper = By.xpath("//a[text()='Operator Information']");
    private By Checksheet = By.xpath("(//span[@class='checkmark'])[6]");
...
//Add sequence
    ...
    private By drag =By.xpath("//p[text()='CheckSheet ']");
    ...
    private By line1 = By.xpath("(//span[@class=\"checkmark\"])[3]");
    private By line2 = By.xpath("(//span[@class=\"checkmark\"])[6]");
    private By line3 = By.xpath("(//span[@class=\"checkmark\"])[9]");
...
//edit chart02
    ...
    private By line4 = By.xpath("(//span[@class=\"checkmark\"])[3]");
    private By line5 = By.xpath("(//span[@class=\"checkmark\"])[6]");
    private By line6 = By.xpath("(//span[@class=\"checkmark\"])[9]");
...
//edit chart03
    ...
    private By line7 = By.xpath("(//span[@class=\"checkmark\"])[3]");
    private By line8 = By.xpath("(//span[@class=\"checkmark\"])[6]");
    private By line9 = By.xpath("(//span[@class=\"checkmark\"])[9]");
...
//edit chart04
    ...
    private By line10 = By.xpath("(//span[@class=\"checkmark\"])[3]");
    private By line11 = By.xpath("(//span[@class=\"checkmark\"])[6]");
    private By line12 = By.xpath("(//span[@class=\"checkmark\"])[9]");
...
//edit chart05
    ...
    private By line13 = By.xpath("(//span[@class=\"checkmark\"])[3]");
    private By line14 = By.xpath("(//span[@class=\"checkmark\"])[6]");
    private By line15 = By.xpath("(//span[@class=\"checkmark\"])[9]");
    ...
    public TestCase22Page(WebDriver driver) {
        this.driver = driver;
...
//Char
    ...
    public void operation() {
        ...
        WebElement addpart = wait.until(ExpectedConditions.elementToBeClickable(oper));
        addpart.click();
    ...
    public void Checksheet() {
        ...
        WebElement addpart = wait.until(ExpectedConditions.elementToBeClickable(Checksheet));
        addpart.click();
...
//            Assert.assertEquals("Popup text did not match the expected value!", expectedText, popupText);
    ...
    public void DDG1() {
        ...
        while(attempts < 3 && !clicked) {
            try {
                WebElement groupElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//p[text()=' SPC_Attribute_Group '])[2]")));
                groupElement.click();
                clicked = true;
    ...
    public void draganddrop() {
        ...
        WebElement para = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()=' CheckSheet ']")));
...
//		creating satellite
    ...
    public void line1() {
        WebElement para = wait.until(ExpectedConditions.elementToBeClickable(line1));
        para.click();
    }


    public void line2() {
        WebElement para = wait.until(ExpectedConditions.elementToBeClickable(line2));
        para.click();
    }
