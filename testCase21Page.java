...
public class testCase21Page {
    ...
    private By networkchar = By.xpath("(//span[@class='checkmark'])[10]");
...
//edit chart05
    ...
    public testCase21Page(WebDriver driver) {
        this.driver = driver;
...
//Char
    ...
    public void addchar() throws InterruptedException {
        ...
        Thread.sleep(1000);
        addpart.sendKeys("HideCharacteristic");
    ...
    public void hide() {
        ...
        WebElement addpart = wait.until(ExpectedConditions.elementToBeClickable(networkchar));
        addpart.click();
