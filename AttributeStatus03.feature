...
Scenario: Validating Avg Trend Up  
...
And  user enters total inspected value for subgroup size01 to verify Avg Trend Up status
...
And  user enters total inspected value for subgroup size02 to verify Avg Trend Up status
...
And  user enters total inspected value for subgroup size03 to verify Avg Trend Up status
...
And  user enters total inspected value for subgroup size04 to verify Avg Trend Up status
...
And  user enters total inspected value for subgroup size05 to verify Avg Trend Up status
