Feature: Verifying Attribute Status
  ...
  Scenario: Verifying Avg Trend Down Status for Attribute status
    #Adding char 18
    ...
    And user clicks on save button to save characterstics Avg Trend Down status for Attribute chart
    ...
    And the user views available groups by clicking the GroDowndropdown01 Avg Trend Down status for Attribute chart
    Then the user selects the appropriate data groDownfrom the dropdown01 Avg Trend Down status for Attribute chart
    And views available parts by clicking the Part dropdown01 Avg Trend Down status for Attribute chart
    ...
    And confirms the addition by clicking the Save button01 Avg Trend Down status for Attribute chart
