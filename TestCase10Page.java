	 ...
	 private By clickaddpara2 = By.xpath("(//img[@class='imgStyle1'])[1]");
		...
		//add sequence
		   ...
		   private By close1 = By.xpath("(//button[text()='Close'])[2]");
		    ...
		    private By editpencil = By.xpath("(//img[@class='EDIT_BLUE'])[10]");
...
//						            Assert.assertEquals("Popup text did not match the expected value!", expectedText, popupText);
						    ...
						    public void Nostaus() throws InterruptedException {
						    	...
						    	WebElement checkmark = driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-layout[1]/div[1]/div[1]/div[2]/lib-characteristics[1]/lib-npopup[1]/div[1]/div[1]/div[1]/lib-add_edit_characteristic[1]/div[1]/div[1]/div[2]/div[2]/lib-control-chart[1]/form[1]/div[1]/div[1]/div[2]/div[7]/div[1]/div[2]/div[1]/div[1]/div[3]/label[1]/label[1]/span[1]"));
						    	((JavascriptExecutor) driver).executeScript("arguments[0].click();", checkmark);
						    	
						    }
						 
						    public void cpkvalue() throws InterruptedException {
							    
						    	WebElement dropdown = driver.findElement(By.id("BenchMarkCPKValue"));
						    	dropdown.sendKeys("1.33");
						    }
...
//						            Assert.assertEquals("Popup text did not match the expected value!", expectedText, popupText);
				...
				;
								...
								public void draganddrop() {
									...
									WebElement para = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='CPK ']")));
...
//									    String expectedResults = "Process in Control ";
									 String expectedResults = "CPK less than 1.33";
									    // Log both results for debugging
									    System.out.println("Expected: '" + expectedResults + "'");
									    System.out.println("Actual: '" + actualResults + "'");
